...
- Database: PostgreSQL – Separate Schema per Tenant
- ORM: Drizzle ORM
- Cache: Redis
- Queue: RabbitMQ
- Features: Multi-tenant, i18n, Email-driven, Public Content, Personal Todo
...
- Tenant schemas:
  - users, projects, tasks, personal_todos, employees, settings
